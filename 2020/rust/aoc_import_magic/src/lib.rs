...
pub fn import_magic<T, F>(day: u32, parse_input_function: F) -> Result<PuzzleOptions<T>, io::Error>
where
...
pub fn import_magic_with_params<T, F>(day: u32, parse_input_function: F, params: &[&str])
...
fn import_from_arg_matches<T, F>(day: u32, parse_input_function: F, args: ArgMatches)
-> Result<PuzzleOptions<T>, io::Error>
where
    T: Debug + Clone + PartialEq,
    F: Fn(Vec<String>, &HashMap<String, String>, bool) -> T,
...
pub fn test_helper_import_config(day: u32, input_name: &str) -> HashMap<String, String> {
