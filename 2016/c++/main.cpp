...
Result run_solver(const PuzzleData puzzle) {
    ...
    case 19: {
        Day19 solver(puzzle.input);
        return solver.solve(puzzle.part);
    }
    case 20: {
        Day20 solver(puzzle.input);
        return solver.solve(puzzle.part);
    }
    case 21: {
        Day21 solver(puzzle.input);
        return solver.solve(puzzle.part);
    }
    case 22: {
        Day22 solver(puzzle.input);
        return solver.solve(puzzle.part);
    }
    case 23: {
        Day23 solver(puzzle.input);
        return solver.solve(puzzle.part);
    }
    case 25: {
        Day25 solver(puzzle.input);
        return solver.solve(puzzle.part);
    }
    default:
