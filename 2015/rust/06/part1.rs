...
// https://www.reddit.com/r/adventofcode/comments/3vmltn/day_6_solutions/cxptu4a
    ...
    println!("There are {} lights on.", count_lightning(lights) );

}

fn turn_on(lights: &mut [[bool; 1000]; 1000], x1: usize, y1: usize,
                                            x2: usize, y2: usize) {
    for ii in x1..x2+1 {
        for jj in y1..y2+1 {
            lights[ii][jj] = true;
...
fn turn_off(lights: &mut [[bool; 1000]; 1000], x1: usize, y1: usize,
                                            x2: usize, y2: usize) {
    for ii in x1..x2+1 {
        for jj in y1..y2+1 {
            lights[ii][jj] = false;
...
fn toggle(lights: &mut [[bool; 1000]; 1000], x1: usize, y1: usize,
                                            x2: usize, y2: usize) {
    for ii in x1..x2+1 {
        for jj in y1..y2+1 {
...
fn count_lightning(lights: [[bool; 1000]; 1000]) -> i32 {
